...
export default function SignUpPage() {
    ...
    async function register(e: any) {
        ...
        if (!strongPass.test(password)) {
            return toast.error("Password must include at least 1 uppercase and 1 number")
        }
            ...
            <div className="w-full lg:w-5/12 flex items-center justify-center p-6 lg:p-12">
                <div className="w-full max-w-md max-auto">
                    ...
                    <form onSubmit={register} className="flex flex-col gap-4">
                        <div className="shadow-sm flex gap-2 items-center bg-white  dark:bg-black dark:text-white p-2 duration-300 border-2 border-gray-400 group delay-200 rounded-md">
                            <svg
                            ...
                            <input placeholder="Name" type="text" onChange={(e) => setName(e.target.value)} className="flex-1 focus:outline-none p-1 dark:bg-black dark:text-white" />
                        </div>
                        ...
                        <div className="p-2 pl-4 flex justify-between">
                            ...
                            >
                                ...
                                <p className="text-xs font-bold [user-select:none]">I agree with <span className="underline">terms and conditions</span></p>
                            </label>
                        </div>
                    ...
                    <p className="text-center text-xs mt-7">Have an account?<Link href="/login"  className="text-blue-800 pl-1">Sign In</Link></p>
                </div>
            </div>
