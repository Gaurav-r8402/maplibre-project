                    ...
                    <form onSubmit={handleLogin} className="flex flex-col gap-4">
                        ...
                        <div className="shadow-sm flex gap-2 items-center bg-white dark:bg-black p-2 duration-300 border-2 border-gray-400 group delay-200 rounded-md">
                            ...
                            <div className="relative flex flex-1 items-center">
                                <input placeholder="password" type={isVisible ? 'text': 'password'} onChange={(e) => setPassword(e.target.value)} className="flex-1  focus:outline-none p-1 dark:bg-black dark:text-white w-full pr-10" />
