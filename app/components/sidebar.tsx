...
export default function Sidebar(){
    ...
    return (
            ...
            <div className={`relative border-r border-gray-300 dark:border-neutral-800 h-screen bg-white dark:bg-black text-black ${open ? "w-64" : "w-16"} duration-300 p-4 flex flex-col`}>
